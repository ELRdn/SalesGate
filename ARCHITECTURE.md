---
title: SalesGate 技術設計ドキュメント（ARCHITECTURE）
description: 承認ファーストAI SDRハブのアーキテクチャ・データフロー・MCPツール一覧
last_updated: 2026-08-16
---

# SalesGate ARCHITECTURE.md — 技術設計ドキュメント
...
│  │  • get_approved_send_items • report_send_result     │    │
│  │  • search_leads            • update_lead_status     │    │
│  │  • create_task / update_task  • request_review      │    │
│  └─────────────────────────────────────────────────────┘    │
│                                                              │
│  ┌─────────────────────────────────────────────────────┐    │
...
| レイヤー | 技術 |
|---|---|
| フレームワーク | Next.js 16.3（App Router） |
...
| `request_review` | 送信前の事前相談 | subject, body, leadId? | REVIEW_REQUESTタスクとして登録 |
...
node tests/e2e-mcp.mjs http://localhost:3000        # E2Eテスト
```
